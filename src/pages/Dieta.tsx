      ...
      <div className="min-h-screen bg-background p-4 max-w-lg mx-auto flex flex-col">
        ...
        <motion.div
          ...
          >
            ...
            <div>
              <h2 className="font-sans text-xl font-bold text-foreground mb-2 tracking-tight uppercase text-balance">
                SELECIONE O SEU PLANO NA ÁREA DE MEMBROS
              </h2>
              <p className="text-sm text-muted-foreground max-w-[280px] mx-auto leading-relaxed">
                Acesse a área de membros para ativar seu plano alimentar e liberar as refeições.
              </p>
            </div>
            <motion.button
